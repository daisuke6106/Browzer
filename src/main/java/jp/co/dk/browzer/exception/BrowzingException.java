...
/**
 * BrowzingExceptionは、HTML、XMLでのブラウザ操作にて例外が発生したことを通知する例外クラスです。
 * 
 * @version 1.0
 * @author D.Kanno
 */
public class BrowzingException extends AbstractMessageException{

	/**
	 * シリアルバージョンID
	 */
	private static final long serialVersionUID = 8573728932127558752L;
